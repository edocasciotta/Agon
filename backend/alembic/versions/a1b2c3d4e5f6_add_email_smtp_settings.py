...
def upgrade() -> None:
    ...
    op.add_column('studio_settings', sa.Column('email_smtp_port', sa.Integer(), nullable=True, server_default='587'))
    ...
    op.add_column('studio_settings', sa.Column('email_smtp_tls', sa.Boolean(), nullable=True, server_default='1'))
